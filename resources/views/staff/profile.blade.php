...
<div class="panel">
  ...
  <form method="POST" action="{{ route('staff.profile.update') }}" novalidate>
    ...
    <div class="auth-field">
      ...
      <input id="password" name="password" type="password" autocomplete="new-password" placeholder="Leave blank to keep your current password" minlength="8" aria-describedby="password-hint" data-testid="staff-profile-password">
