  ...
  <div class="wrap section" data-testid="terms-page">
    ...
    <article class="legal-card">
      ...
      <div class="legal-body">
        ...
        <ul>
          <li><strong>Party Sizes &amp; Booking Horizon:</strong> Online reservations are accepted for parties between 1 and 10 guests up to 60 calendar days in advance (BR35). Larger dining groups up to 50 guests may be arranged directly by calling venue staff (BR35).</li>
          <li><strong>Dining Durations:</strong> To ensure equitable table access for all guests, standard dining seatings are allocated as follows (BR34):
            <ul>
          ...
          <li><strong>Arrival Grace Period &amp; Attendance (BR39):</strong> Reserved tables will be held for up to 15 minutes past your scheduled reservation time. If your party has not arrived or checked in within the 15-minute grace period, the reservation may be recorded as unattended (no-show) and the table released for other guests.</li>
          <li><strong>Modification &amp; Cancellation Lock (BR36, BR38):</strong> Reservation details (date, time, party size) may be modified or cancelled online up to 2 hours prior to your scheduled booking time. Modifications and cancellations within 2 hours of booking time are locked and require contacting venue staff directly; late cancellations within 2 hours are recorded in dining attendance logs (BR38).</li>
        </ul>

        <h2>2. Table QR Ordering &amp; Digital Service</h2>
        <ul>
          <li><strong>Self-Service Ordering:</strong> Orders placed via table QR codes are transmitted directly to the kitchen display and bar stations for immediate preparation upon successful checkout (FR37, FR54, FR55).</li>
          <li><strong>Pricing &amp; Currency (NFR13):</strong> All prices displayed on our menu and digital carts are stated in Australian Dollars (AUD) and are inclusive of Australian Goods and Services Tax (GST, 10%).</li>
          <li><strong>Payment Methods &amp; Settlements:</strong> Orders may be paid digitally via Stripe hosted checkout or via cash settlement at your table (BR22, BR24). Cash transactions are rounded to the nearest 5 cents in accordance with Australian currency convention (BR22).</li>
          <li><strong>Order Changes &amp; Cancellations (BR27, BR28, BR29):</strong> Once an order is submitted and payment is authorized, line items enter preparation immediately. Order cancellations or refund requests are subject to management review and approval; food already prepared cannot be refunded.</li>
        </ul>

        <h2>3. Dietary Requirements &amp; Allergen Advisory</h2>
        <div class="legal-callout" data-testid="terms-allergen-callout">
          <strong>Food Allergies &amp; Severe Dietary Restrictions (FR33, BR48)</strong>
